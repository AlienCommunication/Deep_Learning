...
def changing_saturation(image_path):
...
def image_sharpen(image_path):
    ...
    the same depth of the source image
    """
...
def composite(background_img_path, foreground_img_path, alpha_img_path):
    ...
    """ Multiplying the foreground with the alpha matte"""
    foreground = cv2.multiply(alpha, foreground)

    """ Multiplying the background with ( 1 - alpha )"""
    background = cv2.multiply(1.0 - alpha, background)

    """Adding the masked background and foreground"""
...
if __name__ == '__main__':
    ...
    changing_contrast('input' + os.sep + 'c.jpg')
    brighteness('input' + os.sep + 'princeton_small.jpg')
    blur('input' + os.sep + 'princeton_small.jpg')
    image_sharpen('input' + os.sep + 'princeton_small.jpg')
    edge_detection('input' + os.sep + 'princeton_small.jpg')
    changing_saturation('input' + os.sep + 'scaleinput.jpg')
